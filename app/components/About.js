                ...
                <div className="flex flex-col items-start xl:w-1/2 xl:mt-0">
                    ...
                    <div className="my-2">
                        <p className="my-3 mx-0 text-white text-xl">
                            ...
                            projects both during my free time and in hackathons not only
                            with Python and JavaScript Languages but also frameworks such as React JS and Next JS. <br /> <br /> I am consantly
                            eager to learn, highly adaptable and goal driven.
                        </p>
                        <p className="my-3 mx-0 text-white text-xl">
                            When am not coding, I go to different meetup circles,
                            visit friends, do cycling and netflixing.
                        </p>
                    </div>
                    <div className="my-6">
